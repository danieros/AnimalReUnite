...
namespace AnimalsUniteAPI
{
    ...
    public class AzureCommon
    {
        ...
        private static CloudStorageAccount StorageAccount = CloudStorageAccount.Parse("AccountName=petsocietyphotos;AccountKey=YBMZXXt+7aroXmigyc2wMLzbRQB+wjDDA1gNZkYwTx3fDYdXmpkGCPURkL4VFwP1gg8Jz2/Dq7xeyr6IEAusQA==;DefaultEndpointsProtocol=https");
        ...
        public const string ImageContainerName = "animalphotos";
